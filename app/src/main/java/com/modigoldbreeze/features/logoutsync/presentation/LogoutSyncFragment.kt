package com.modigoldbreeze.features.logoutsync.presentation
...
import com.modigoldbreeze.app.AppDatabase
...
import com.modigoldbreeze.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.modigoldbreeze.features.billing.api.AddBillingRepoProvider
import com.modigoldbreeze.features.billing.model.AddBillingInputParamsModel
...
import com.modigoldbreeze.features.dashboard.presentation.ReasonDialog
...
import com.modigoldbreeze.features.document.model.AddEditDocumentInputParams
import com.modigoldbreeze.features.document.model.DocumentAttachmentModel
...
import com.modigoldbreeze.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.modigoldbreeze.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.modigoldbreeze.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.modigoldbreeze.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.modigoldbreeze.features.orderhistory.model.*
...
import com.modigoldbreeze.features.quotation.model.AddQuotInputModel
import com.modigoldbreeze.features.shopdetail.presentation.api.EditShopRepoProvider
import com.modigoldbreeze.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.modigoldbreeze.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.modigoldbreeze.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.modigoldbreeze.features.timesheet.model.AddTimeSheetInputModel
import com.modigoldbreeze.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.modigoldbreeze.features.viewAllOrder.model.AddOrderInputParamsModel
import com.modigoldbreeze.features.viewAllOrder.model.AddOrderInputProductList
import com.modigoldbreeze.mappackage.SendBrod
import com.modigoldbreeze.widgets.AppCustomTextView
import com.modigoldbreeze.MonitorService
import com.modigoldbreeze.MySingleton
import com.modigoldbreeze.app.AlarmReceiver
...
import com.modigoldbreeze.features.addshop.presentation.ShopExtraContactReq
...
import com.modigoldbreeze.features.dashboard.presentation.model.AudioSyncModel
...
import com.modigoldbreeze.features.login.model.GetConcurrentUserResponse
import com.modigoldbreeze.features.login.model.WhatsappApiData
import com.modigoldbreeze.features.orderITC.SyncDeleteOppt
import com.modigoldbreeze.features.orderITC.SyncDeleteOpptL
import com.modigoldbreeze.features.orderITC.SyncEditOppt
import com.modigoldbreeze.features.orderITC.SyncOppt
import com.modigoldbreeze.features.orderITC.SyncOpptProductL
import com.modigoldbreeze.features.orderITC.SyncOrd
import com.modigoldbreeze.features.orderITC.SyncOrdProductL
import com.modigoldbreeze.features.performance.model.Gps_status_list
import com.modigoldbreeze.features.performance.model.UpdateGpsInputListParamsModel
import com.modigoldbreeze.features.returnsOrder.ReturnProductList
import com.modigoldbreeze.features.returnsOrder.ReturnRequest
import com.modigoldbreeze.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmodigoldbreezelogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmodigoldbreezelogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmodigoldbreezelogsample/log.zip").path);
