...
import com.modigoldbreeze.*
import com.modigoldbreeze.R
import com.modigoldbreeze.app.*
import com.modigoldbreeze.app.NewFileUtils.browseDocuments
import com.modigoldbreeze.app.NewFileUtils.browsePDFDocuments
import com.modigoldbreeze.app.NewFileUtils.getExtension
import com.modigoldbreeze.app.domain.*
import com.modigoldbreeze.app.types.DashboardType
import com.modigoldbreeze.app.types.FragType
import com.modigoldbreeze.app.types.TopBarConfig
import com.modigoldbreeze.app.uiaction.DisplayAlert
import com.modigoldbreeze.app.utils.*
import com.modigoldbreeze.app.utils.AppUtils.Companion.isProfile
import com.modigoldbreeze.base.BaseResponse
import com.modigoldbreeze.base.presentation.BaseActivity
import com.modigoldbreeze.base.presentation.BaseFragment
import com.modigoldbreeze.features.NewQuotation.*
import com.modigoldbreeze.features.NewQuotation.api.GetQuotRegProvider
import com.modigoldbreeze.features.NewQuotation.model.ViewDetailsQuotResponse
import com.modigoldbreeze.features.SearchLocation.SearchLocationFragment
import com.modigoldbreeze.features.SearchLocation.locationInfoModel
import com.modigoldbreeze.features.TA.ViewAllTAListFragment
import com.modigoldbreeze.features.achievement.AchievementFragment
import com.modigoldbreeze.features.activities.presentation.*
import com.modigoldbreeze.features.addAttendence.*
import com.modigoldbreeze.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.modigoldbreeze.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.modigoldbreeze.features.addAttendence.model.GetReportToFCMResponse
import com.modigoldbreeze.features.addAttendence.model.GetReportToResponse
import com.modigoldbreeze.features.addAttendence.model.Leave_list_Response
import com.modigoldbreeze.features.addorder.presentation.AddOrderFragment
...
import com.modigoldbreeze.features.addshop.presentation.AddShopFragment
import com.modigoldbreeze.features.addshop.presentation.OTPVerificationDialog
import com.modigoldbreeze.features.addshop.presentation.ScanImageFragment
import com.modigoldbreeze.features.addshop.presentation.ShowCardDetailsDialog
import com.modigoldbreeze.features.alarm.model.AlarmData
import com.modigoldbreeze.features.alarm.presetation.AttendanceReportFragment
import com.modigoldbreeze.features.alarm.presetation.PerformanceReportFragment
import com.modigoldbreeze.features.alarm.presetation.VisitReportDetailsFragment
import com.modigoldbreeze.features.alarm.presetation.VisitReportFragment
import com.modigoldbreeze.features.attendance.AttendanceFragment
import com.modigoldbreeze.features.attendance.api.AttendanceRepositoryProvider
import com.modigoldbreeze.features.attendance.model.AttendanceRequest
import com.modigoldbreeze.features.attendance.model.AttendanceResponse
import com.modigoldbreeze.features.averageshop.presentation.AverageShopFragment
import com.modigoldbreeze.features.avgorder.presentation.AverageOrderFragment
import com.modigoldbreeze.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.modigoldbreeze.features.beatCustom.TeamBeatListFragment
import com.modigoldbreeze.features.billing.presentation.AddBillingFragment
import com.modigoldbreeze.features.billing.presentation.BillingDetailsFragment
import com.modigoldbreeze.features.billing.presentation.BillingListFragment
import com.modigoldbreeze.features.changepassword.presentation.ChangePasswordDialog
import com.modigoldbreeze.features.chat.model.ChatListDataModel
import com.modigoldbreeze.features.chat.model.ChatUserDataModel
import com.modigoldbreeze.features.chat.model.GroupUserDataModel
import com.modigoldbreeze.features.chat.presentation.*
import com.modigoldbreeze.features.chatbot.presentation.ChatBotFragment
import com.modigoldbreeze.features.chatbot.presentation.ChatBotShopListFragment
import com.modigoldbreeze.features.chatbot.presentation.ReportsFragment
import com.modigoldbreeze.features.chatbot.presentation.SelectLanguageDialog
import com.modigoldbreeze.features.commondialog.presentation.CommonDialog
import com.modigoldbreeze.features.commondialog.presentation.CommonDialogClickListener
import com.modigoldbreeze.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.modigoldbreeze.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.modigoldbreeze.features.commondialogsinglebtn.OnDialogClickListener
import com.modigoldbreeze.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.modigoldbreeze.features.contacts.ActivityDtlsFrag
import com.modigoldbreeze.features.contacts.AddOpptFrag
import com.modigoldbreeze.features.contacts.ContactDtls
import com.modigoldbreeze.features.contacts.ContactGr
import com.modigoldbreeze.features.contacts.ContactsAddFrag
import com.modigoldbreeze.features.contacts.ContactsFrag
import com.modigoldbreeze.features.contacts.SchedulerAddFormFrag
import com.modigoldbreeze.features.contacts.SchedulerViewFrag
import com.modigoldbreeze.features.contacts.TemplateAddFrag
import com.modigoldbreeze.features.contacts.TemplateViewFrag
import com.modigoldbreeze.features.contacts.ViewCrmOpptFrag
import com.modigoldbreeze.features.dailyPlan.prsentation.AllShopListFragment
import com.modigoldbreeze.features.dailyPlan.prsentation.DailyPlanListFragment
import com.modigoldbreeze.features.dailyPlan.prsentation.PlanDetailsFragment
import com.modigoldbreeze.features.damageProduct.ShopDamageProductListFrag
import com.modigoldbreeze.features.damageProduct.ShopDamageProductSubmitFrag
import com.modigoldbreeze.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.modigoldbreeze.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.modigoldbreeze.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.modigoldbreeze.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.modigoldbreeze.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.modigoldbreeze.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.modigoldbreeze.features.dashboard.presentation.model.ContentListResponseModel
import com.modigoldbreeze.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.modigoldbreeze.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.modigoldbreeze.features.device_info.presentation.DeviceInfoListFragment
import com.modigoldbreeze.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.modigoldbreeze.features.document.DocumentRepoFeatureNewFragment
import com.modigoldbreeze.features.document.presentation.DocumentListFragment
import com.modigoldbreeze.features.document.presentation.DocumentTypeListFragment
import com.modigoldbreeze.features.document.presentation.OpenFileWebViewFragment
import com.modigoldbreeze.features.dymanicSection.presentation.AddDynamicFragment
import com.modigoldbreeze.features.dymanicSection.presentation.AllDynamicListFragment
import com.modigoldbreeze.features.dymanicSection.presentation.DynamicListFragment
import com.modigoldbreeze.features.dymanicSection.presentation.EditDynamicFragment
import com.modigoldbreeze.features.gpsDisabilityScreen.GpsDisableFragment
import com.modigoldbreeze.features.home.presentation.HomeFragment
import com.modigoldbreeze.features.homelocation.presentation.HomeLocationFragment
import com.modigoldbreeze.features.homelocation.presentation.HomeLocationMapFragment
import com.modigoldbreeze.features.know_your_state.KnowYourStateFragment
import com.modigoldbreeze.features.lead.LeadFrag
import com.modigoldbreeze.features.lead.ViewLeadFrag
import com.modigoldbreeze.features.leaderboard.LeaderBoardFrag
import com.modigoldbreeze.features.leaveapplynew.LeaveHome
import com.modigoldbreeze.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.modigoldbreeze.features.localshops.LocalShopListFragment
import com.modigoldbreeze.features.localshops.LocalShopListMapFragment
import com.modigoldbreeze.features.localshops.NearByShopsMapFragment
import com.modigoldbreeze.features.location.*
import com.modigoldbreeze.features.location.api.LocationRepoProvider
import com.modigoldbreeze.features.location.model.*
import com.modigoldbreeze.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.modigoldbreeze.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.modigoldbreeze.features.login.ShopFeedbackEntity
import com.modigoldbreeze.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.modigoldbreeze.features.login.presentation.LoginActivity
import com.modigoldbreeze.features.logout.presentation.api.LogoutRepositoryProvider
import com.modigoldbreeze.features.logoutsync.presentation.LogoutSyncFragment
import com.modigoldbreeze.features.marketAssist.MarketAssistTabFrag
import com.modigoldbreeze.features.marketAssist.ShopDtlsMarketAssistFrag
import com.modigoldbreeze.features.marketAssist.ShopListMarketAssistFrag
import com.modigoldbreeze.features.marketing.presentation.MarketingPagerFragment
import com.modigoldbreeze.features.meetinglist.prsentation.MeetingListFragment
import com.modigoldbreeze.features.member.MapViewForTeamFrag
import com.modigoldbreeze.features.member.model.TeamLocDataModel
import com.modigoldbreeze.features.member.model.TeamShopListDataModel
import com.modigoldbreeze.features.member.presentation.*
import com.modigoldbreeze.features.menuBeat.MenuBeatFrag
import com.modigoldbreeze.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.modigoldbreeze.features.micro_learning.presentation.MicroLearningListFragment
import com.modigoldbreeze.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.modigoldbreeze.features.myallowancerequest.MyallowanceRequestFragment
import com.modigoldbreeze.features.myjobs.model.CustomerDataModel
import com.modigoldbreeze.features.myjobs.presentation.*
import com.modigoldbreeze.features.mylearning.MyLearningFragment
import com.modigoldbreeze.features.myorder.presentation.MyOrderListFragment
import com.modigoldbreeze.features.myprofile.presentation.MyProfileFragment
import com.modigoldbreeze.features.nearbyshops.api.ShopListRepositoryProvider
import com.modigoldbreeze.features.nearbyshops.model.ShopData
import com.modigoldbreeze.features.nearbyshops.model.ShopListResponse
import com.modigoldbreeze.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.modigoldbreeze.features.nearbyshops.presentation.BeatListFragment
import com.modigoldbreeze.features.nearbyshops.presentation.NearByShopsListFragment
import com.modigoldbreeze.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.modigoldbreeze.features.nearbyshops.presentation.ShopCallHisFrag
import com.modigoldbreeze.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.modigoldbreeze.features.newcollection.CollectionDetailsStatusFragment
import com.modigoldbreeze.features.newcollection.CollectionShopListFragment
import com.modigoldbreeze.features.newcollection.NewCollectionListFragment
import com.modigoldbreeze.features.newcollectionreport.*
import com.modigoldbreeze.features.notification.NotificationFragment
import com.modigoldbreeze.features.orderITC.CartListFrag
import com.modigoldbreeze.features.orderITC.OrderListFrag
import com.modigoldbreeze.features.orderITC.ProductListFrag
import com.modigoldbreeze.features.orderITC.ViewNewOrdHisAllFrag
import com.modigoldbreeze.features.orderITC.ViewNewOrdHistoryFrag
import com.modigoldbreeze.features.orderITC.ViewOrdDtls
import com.modigoldbreeze.features.orderList.NewDateWiseOrderListFragment
import com.modigoldbreeze.features.orderList.NewOrderListFragment
import com.modigoldbreeze.features.orderList.OrderListFragment
import com.modigoldbreeze.features.orderdetail.presentation.OrderDetailFragment
import com.modigoldbreeze.features.orderhistory.ActivityMapFragment
import com.modigoldbreeze.features.orderhistory.OrderhistoryFragment
import com.modigoldbreeze.features.orderhistory.TimeLineFragment
import com.modigoldbreeze.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.modigoldbreeze.features.orderhistory.model.LocationData
import com.modigoldbreeze.features.pendinglocationinout.PendingOutLocationFrag
import com.modigoldbreeze.features.performance.GpsStatusFragment
import com.modigoldbreeze.features.performance.PerformanceFragment
import com.modigoldbreeze.features.performance.api.UpdateGpsStatusRepoProvider
import com.modigoldbreeze.features.performance.model.UpdateGpsInputParamsModel
import com.modigoldbreeze.features.performanceAPP.OwnPerformanceFragment
import com.modigoldbreeze.features.performanceAPP.PerformanceAppFragment
import com.modigoldbreeze.features.performanceAPP.allPerformanceFrag
import com.modigoldbreeze.features.permissionList.ViewPermissionFragment
import com.modigoldbreeze.features.photoReg.*
import com.modigoldbreeze.features.privacypolicy.PrivacypolicyWebviewFrag
import com.modigoldbreeze.features.quotation.presentation.*
import com.modigoldbreeze.features.reimbursement.presentation.*
import com.modigoldbreeze.features.report.presentation.*
import com.modigoldbreeze.features.returnsOrder.*
import com.modigoldbreeze.features.settings.presentation.SettingsFragment
import com.modigoldbreeze.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.modigoldbreeze.features.shopdetail.presentation.*
import com.modigoldbreeze.features.shopdetail.presentation.api.EditShopRepoProvider
import com.modigoldbreeze.features.stock.StockDetailsFragment
import com.modigoldbreeze.features.stock.StockListFragment
import com.modigoldbreeze.features.stockAddCurrentStock.AddShopStockFragment
import com.modigoldbreeze.features.stockAddCurrentStock.UpdateShopStockFragment
import com.modigoldbreeze.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.modigoldbreeze.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.modigoldbreeze.features.stockCompetetorStock.AddCompetetorStockFragment
import com.modigoldbreeze.features.stockCompetetorStock.CompetetorStockFragment
import com.modigoldbreeze.features.stockCompetetorStock.ViewComStockProductDetails
import com.modigoldbreeze.features.survey.SurveyFrag
import com.modigoldbreeze.features.survey.SurveyViewDtlsFrag
import com.modigoldbreeze.features.survey.SurveyViewFrag
import com.modigoldbreeze.features.task.presentation.AddTaskFragment
import com.modigoldbreeze.features.task.presentation.CalenderTaskFragment
import com.modigoldbreeze.features.task.presentation.EditTaskFragment
import com.modigoldbreeze.features.task.presentation.TaskListFragment
import com.modigoldbreeze.features.taskManagement.TaskManagementFrag
import com.modigoldbreeze.features.taskManagement.ViewTaskManagementFrag
import com.modigoldbreeze.features.timesheet.presentation.AddTimeSheetFragment
import com.modigoldbreeze.features.timesheet.presentation.EditTimeSheetFragment
import com.modigoldbreeze.features.timesheet.presentation.TimeSheetListFragment
import com.modigoldbreeze.features.viewAllOrder.CartFragment
import com.modigoldbreeze.features.viewAllOrder.OrderTypeListFragment
import com.modigoldbreeze.features.viewAllOrder.ViewAllOrderListFragment
import com.modigoldbreeze.features.viewAllOrder.ViewCartFragment
import com.modigoldbreeze.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.modigoldbreeze.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.modigoldbreeze.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.modigoldbreeze.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.modigoldbreeze.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.modigoldbreeze.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.modigoldbreeze.features.viewPPDDStock.ViewOutstandingFragment
import com.modigoldbreeze.features.viewPPDDStock.ViewPPDDListFragment
import com.modigoldbreeze.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.modigoldbreeze.features.viewPPDDStock.ViewStockFragment
import com.modigoldbreeze.features.weather.presentation.WeatherFragment
import com.modigoldbreeze.mappackage.MapActivity
import com.modigoldbreeze.mappackage.MapActivityWithoutPath
import com.modigoldbreeze.mappackage.SendBrod
...
import com.modigoldbreeze.features.login.api.opportunity.OpportunityRepoProvider
import com.modigoldbreeze.features.login.model.NewSettingsResponseModel
import com.modigoldbreeze.features.mylearning.AllTopicsWiseContents
import com.modigoldbreeze.features.mylearning.BookmarkFetchResponse
import com.modigoldbreeze.features.mylearning.BookmarkFrag
import com.modigoldbreeze.features.mylearning.BookmarkPlayFrag
import com.modigoldbreeze.features.mylearning.KnowledgeHubAllVideoList
import com.modigoldbreeze.features.mylearning.LeaderboardLmsFrag
import com.modigoldbreeze.features.mylearning.LmsQuestionAnswerSet
import com.modigoldbreeze.features.mylearning.MyLearningAllVideoList
import com.modigoldbreeze.features.mylearning.MyLearningTopicList
import com.modigoldbreeze.features.mylearning.MyLearningVideoPlay
import com.modigoldbreeze.features.mylearning.MyPerformanceFrag
import com.modigoldbreeze.features.mylearning.MyTopicsWiseContents
import com.modigoldbreeze.features.mylearning.NotificationLMSFragment
import com.modigoldbreeze.features.mylearning.SearchLmsFrag
import com.modigoldbreeze.features.mylearning.SearchLmsKnowledgeFrag
import com.modigoldbreeze.features.mylearning.SearchLmsLearningFrag
import com.modigoldbreeze.features.mylearning.VideoPlayLMS
import com.modigoldbreeze.features.mylearning.apiCall.LMSRepoProvider
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xmodigoldbreezelogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmodigoldbreezelogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.modigoldbreeze/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xmodigoldbreezelogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xmodigoldbreezelogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xmodigoldbreezelogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
